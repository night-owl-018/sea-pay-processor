...
def download_merged():
    # Collect all generated PDFs in OUTPUT_DIR (ignore the merged file itself if it exists)
    pdf_files = sorted(
    ...
    log(f"MERGED CREATED → {os.path.basename(merged_path)}")
